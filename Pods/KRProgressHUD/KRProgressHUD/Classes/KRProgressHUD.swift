...
extension KRProgressHUD {
   ...
   /**
    ...
    - parameter message: HUD's message (option).
    */
   public static func showImage(_ image: UIImage, size: CGSize? = nil, message: String? = nil,completion: CompletionHandler? = nil) {
    shared.show(withMessage: message, image: image, imageSize: size, isLoading: true, completion : completion)
   }
